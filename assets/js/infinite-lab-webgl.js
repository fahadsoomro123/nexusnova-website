...
function exoRow(r){
 const d=n(r.sy_dist);
 return finish({id:'exo-'+(r.pl_name||'object'),name:st(r.pl_name)||'NOT REPORTED',source:'NASA Exoplanet Archive',sourceKey:'exo',sourceType:'REAL CATALOG',release:'PSCompPars',ra:n(r.ra),dec:n(r.dec),distanceLy:d==null?null:d*3.26156,distanceUncertaintyLy:n(r.sy_disterr1)==null?null:Math.abs(n(r.sy_disterr1))*3.26156,radius:n(r.pl_rade),mass:n(r.pl_masse),orbitalPeriodDays:n(r.pl_orbper),semiMajorAxisAu:n(r.pl_orbsmax),eccentricity:n(r.pl_orbeccen),temperatureK:n(r.st_teff),planet:st(r.pl_name),host:st(r.hostname),reference:st(r.disc_refname)||st(r.discoverymethod)||'NASA Exoplanet Archive',sourceUrl:r.pl_name?'https://exoplanetarchive.ipac.caltech.edu/overview/'+encodeURIComponent(r.pl_name):'https://exoplanetarchive.ipac.caltech.edu/'});
}
