...
const WORLDS = [
  ...
  {name:'COSMIC FILAMENTS',family:'LARGE-SCALE STRUCTURE',type:'PROCEDURAL VISUALIZATION',scale:'LARGE-SCALE STRUCTURE',desc:'A survey-inspired network for exploring redshift depth and galaxy distributions. Filaments are visualized from sampled records; they are not claimed as a complete observed cosmic web.'},
  ...
  {name:'ORBITAL GARDEN',family:'STELLAR REGION',type:'REAL CATALOG',scale:'STELLAR NEIGHBORHOOD',desc:'Catalog-backed stars are placed over a deterministic stellar-region context. Point positions and measurements keep their source provenance.'},
