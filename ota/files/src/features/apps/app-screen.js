...
const rendererSources = [
  ...
  ['./hadith-safe.js', 'hadithSafeRenderers'],
  ['./browser-safe.js', 'browserSafeRenderers'],
  ['./premium-weather.js', 'premiumWeatherRenderers'],
  ['./premium-qibla-safe-v2.js', 'qiblaSafeV2Renderers'],
  ['./premium-qibla.js', 'premiumQiblaRenderers'],
  ['./premium-prayer-safe.js', 'premiumPrayerSafeRenderers'],
  ['./premium-prayer-times.js', 'premiumPrayerRenderers'],
  ['./premium-world-clock.js', 'premiumWorldClockRenderers'],
  ['./premium-drive-native-v2.js', 'driveNativeV2Renderers'],
  ['./premium-drive-safe.js', 'premiumDriveSafeRenderers'],
  ['./premium-drive-tools.js', 'premiumDriveRenderers'],
  ['./premium-quran-reader.js', 'premiumQuranRenderers'],
  ['./documents-live-suite.js', 'documentsLiveRenderers'],
  ['./teacher-ai-suite.js', 'teacherAIRenderers'],
  ['./pakistan-suite.js', 'pakistanSuiteRenderers'],
  ['./articles-suite.js', 'articleRenderers'],
  ['./nova-vpn-suite.js', 'novaVpnRenderers'],
  ['./news-suite.js', 'newsSuiteRenderers'],
  ['./entertainment-resilient.js', 'entertainmentResilientRenderers'],
  ['./entertainment-live-suite.js', 'entertainmentLiveRenderers'],
  ['./entertainment-suite.js', 'entertainmentSuiteRenderers'],
  ['./urdu-library-suite.js', 'urduLibraryRenderers'],
  ['./location-suite.js', 'locationSuiteRenderers'],
  ['./notifications-suite.js', 'notificationsSuiteRenderers'],
  ['./security-lock-suite.js', 'securityLockSuiteRenderers'],
  ['./file-vault-suite.js', 'fileVaultSuiteRenderers'],
  ['./marketplace-suite.js', 'marketplaceSuiteRenderers'],
  ['./core-enhancements.js', 'coreEnhancementRenderers'],
  ['./core-apps.js', 'coreRenderers'],
  ['./health-suite.js', 'healthSuiteRenderers'],
  ['./family-suite.js', 'familySuiteRenderers'],
  ['./personal-apps.js', 'personalRenderers'],
  ['./teacher-suite.js', 'teacherSuiteRenderers'],
  ['./islamic-suite.js', 'islamicSuiteRenderers'],
  ['./documents-suite.js', 'documentsSuiteRenderers'],
  ['./community-chat.js', 'communityChatRenderers'],
  ...
  ['./smart-apps.js', 'smartRenderers'],
  ['./everyday-tools.js', 'everydayRenderers'],
  ['./live-tools.js', 'liveRenderers']
];

const rendererCache = new Map();

async function loadRendererBag(path, exportName) {
  if (!rendererCache.has(path)) {
    rendererCache.set(path, import(path).catch(error => {
      rendererCache.delete(path);
      console.warn(`[NexusNova Fresh] skipped renderer bundle ${path}:`, error);
      return null;
    }));
  }
  const module = await rendererCache.get(path);
