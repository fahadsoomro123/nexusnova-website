...
test('GA4 bootstrap preserves the automatic pre-audit tracking contract',()=>{
  ...
  assert.match(wrapper,/data-nexusnova-ga4/);
});

test('site shell remains compatible with the restored automatic GA4 bootstrap',()=>{
...
test('tool analytics events remain safe when GA4 is unavailable',()=>{
